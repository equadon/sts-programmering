...
abstract class Piece {
    ...
    Piece.Type pieceType;                    // Type of piece
    ...
    static Piece newPiece(Piece.Type pt, boolean w, boolean my, Board.Position p, Board b)              // create new piece of right type
    {
    ...
    private Area circArea(int radius, boolean isCirc) {
        ...
        if (isCirc) {
            circ = new Ellipse2D.Float((int) (pos.x - radius), (int) (pos.y - radius), (int) (2 * radius), (int) (2 * radius));
        }

        // shape == 1: generate square

        else if (board.shape == 1) {
            circ = new Rectangle((int) (pos.x - radius / Math.sqrt(2)), (int) (pos.y - radius / Math.sqrt(2)), (int) (radius * Math.sqrt(2)), (int) (radius * Math.sqrt(2)));
        }
...

    {
        ...
        Color color = whiteside ? (whitecontrolled ? Color.white : (blackcontrolled ? WHITE_OPPONENT : WHITE_NEUTRAL)) : (blackcontrolled ? Color.black : (whitecontrolled ? BLACK_OPPONENT : BLACK_NEUTRAL));
        if (underAttack) {
