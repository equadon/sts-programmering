...
class Keep extends Piece {
    ...
    final private int[] Kx = {KM, BSIZE / 2 - KW / 2, BSIZE / 2 - KW / 2, BSIZE / 2 + KW / 2, BSIZE / 2 + KW / 2, BSIZE - KM, BSIZE - KM, BSIZE / 2 + KW / 2, BSIZE / 2 + KW / 2, BSIZE / 2 - KW / 2, BSIZE / 2 - KW / 2, KM};
    final private int[] Ky = {BSIZE / 2 - KW / 2, BSIZE / 2 - KW / 2, KM, KM, BSIZE / 2 - KW / 2, BSIZE / 2 - KW / 2, BSIZE / 2 + KW / 2, BSIZE / 2 + KW / 2, BSIZE - KM, BSIZE - KM, BSIZE / 2 + KW / 2, BSIZE / 2 + KW / 2};
